...
<!-- Header Starts Here -->
    <header class="shadow-lg">
        <nav class="navbar navbar-expand-xl navbar-light bg-transparent">
            <div class="container">
                <!-- Logo -->
                <a class="navbar-brand" href="http://localhost/elearning/">
                ...
                <div class="collapse navbar-collapse d-none d-xl-block d-none d-xl-block" id="navbarSupportedContent">
                    <ul class="navbar-nav mx-auto mb-2 mb-lg-0">
                        <li class="nav-item">
                            <a class="nav-link " aria-current="page" href="http://localhost/elearning/home">
                                Home
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" aria-current="page" href="http://localhost/elearning/searchCourse">
                                Course
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" aria-current="page" href="http://localhost/elearning/about">About</a>
                        </li>
                        <li class="nav-item">
                          <router-link :to="'/'" class="nav-link active" >Events</router-link>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="http://localhost/elearning/contact">Contact</a>
                        </li>
                    </ul>
                    <div class="d-flex align-items-center justify-content-between rightContent">
                        ...
                        <a href="http://localhost/elearning/cart" class="cart-nav border-0 bg-transparent mx-3">
                        ...
                        <a href="http://localhost/elearning/student/login" class="button button--text">Sign in</a>
                        <a href="http://localhost/elearning/student/register" class="button button--dark">Sign Up</a>
                    </div>
                </div>
            </div>
        </nav>
