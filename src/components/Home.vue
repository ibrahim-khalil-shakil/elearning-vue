<template>
  <!-- Banner Starts Here -->
  <section class="main-banner" style="background-image: url(dist/images/banner/banner.jpg);">
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-5 order-1 order-lg-0">
          <div class="main-banner-end">
            <img src="dist/images/banner/banner-image-01.png" alt="image" class="img-fluid" />
          </div>
        </div>
      </div>
    </div>
  ...
  <section class="section browse-categories">
    <div class="container">
      ...
      <div class="browse-categories__wrapper position-relative">
        <div class="categories--box">
          <div class="browse-categories-item default-item-one" v-for="cat in course_categories" :key="cat.id">
    ...
    <div class="browse-categories-shape">
      <img src="dist/images/shape/dots/dots-img-11.png" alt="shape" class="img-fluid shape-01" />
      <img src="dist/images/shape/line01.png" alt="shape" class="img-fluid shape-02" />
    </div>
  </section>  
   ...
   <!-- <section class="section browse-categories">
          <div class="container">
              ...
              <div class="row mx-auto my-auto justify-content-center ">
                  <div id="recipeCarousel" class="carousel slide" data-bs-ride="carousel" data-bs-interval="1">
                      <div class="carousel-inner" role="listbox">
                          <div class="carousel-item  mb-2" v-for="cat in course_categories" :key="cat.id">
              ...
              <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                ...
                <li class="nav-item" role="presentation">
                  <button class="nav-link" id="pills-design-tab" data-bs-toggle="pill" data-bs-target="#pills-design"
                    type="button" role="tab" aria-controls="pills-design" aria-selected="false">
                    Design
                  </button>
                </li>
                <li class="nav-item" role="presentation">
                  <button class="nav-link" id="pills-dev-tab" data-bs-toggle="pill" data-bs-target="#pills-dev"
                    type="button" role="tab" aria-controls="pills-dev" aria-selected="false">
                    Development
                  </button>
                </li>
                <li class="nav-item" role="presentation">
                  <button class="nav-link" id="pills-bus-tab" data-bs-toggle="pill" data-bs-target="#pills-bus"
                    type="button" role="tab" aria-controls="pills-bus" aria-selected="false">
                    Business
                  </button>
                </li>
                <li class="nav-item" role="presentation">
                  <button class="nav-link me-0" id="pills-its-tab" data-bs-toggle="pill" data-bs-target="#pills-its"
                    type="button" role="tab" aria-controls="pills-its" aria-selected="false">
                    IT & Software
                  </button>
                </li>
              </ul>
          ...
          <div class="tab-pane fade show active" id="pills-all" role="tabpanel" aria-labelledby="pills-all-tab">
            <div class="row">
              <div class="col-xl-4 col-md-6">
                <div class="contentCard contentCard--course">
                  <div class="contentCard-top">
                    <a href="course-details.html"><img src="dist/images/courses/demo-img-01.png" alt="images"
                        class="img-fluid" /></a>
                  </div>
              ...
              <div class="col-xl-4 col-md-6">
                <div class="contentCard contentCard--course">
                  <div class="contentCard-top">
                    <a href="course-details.html"><img src="dist/images/courses/demo-img-02.png" alt="images"
                        class="img-fluid" /></a>
                  </div>
                  <div class="contentCard-bottom">
                    <h5>
              ...
              <div class="col-xl-4 col-md-6">
                <div class="contentCard contentCard--course">
                  <div class="contentCard-top">
                    <a href="course-details.html"><img src="dist/images/courses/demo-img-03.png" alt="images"
                        class="img-fluid" /></a>
                  </div>
                  <div class="contentCard-bottom">
                    <h5>
              ...
              <div class="col-xl-4 col-md-6">
                <div class="contentCard contentCard--course">
                  <div class="contentCard-top">
                    <a href="course-details.html"><img src="dist/images/courses/demo-img-04.png" alt="images"
                        class="img-fluid" /></a>
                  </div>
                  <div class="contentCard-bottom">
                    <h5>
              ...
              <div class="col-xl-4 col-md-6">
                <div class="contentCard contentCard--course">
                  <div class="contentCard-top">
                    <a href="course-details.html"><img src="dist/images/courses/demo-img-05.png" alt="images"
                        class="img-fluid" /></a>
                  </div>
                  <div class="contentCard-bottom">
                    <h5>
                ...
                <div class="contentCard contentCard--course">
                  <div class="contentCard-top">
                    <a href="course-details.html">
                      <img src="dist/images/courses/demo-img-02.png" alt="images" class="img-fluid" />
                    </a>
                  </div>
                  <div class="contentCard-bottom">
                    <h5>
      ...
      <div class="row align-items-center">
            ...
            <div class="learning-rules__wrapper">
              <div class="learning-rules-item">
                ...
                <div class="item-text">
                  ...
                  <p>
                    Fusce dictum, velit eu placerat consectetur, ante nisl auctor magna, sit amet fringilla urna nibh a
                    risus.
                  </p>
                </div>
              </div>
              <div class="learning-rules-item">
                ...
                <div class="item-text">
                  ...
                  <p>
                    Morbi id est a risus sollicitudin maximus. Fusce lorem neque, tincidunt vel rhoncus eget, convallis
                    ullamcorper sem.
                  </p>
                </div>
              </div>
        ...
        <div class="col-lg-6 order-1 order-lg-0">
          <div class="learning-rules-ends">
            <img src="dist/images/hero/hero-img-01.jpg" alt="img" class="img-fluid" />
  ...
  <section class="section about-services section section--bg-offgradient">
    <div class="container about-services-area">
      ...
      <div class="testimonial testimonial--one testimonial__slider--one">
        <div class="testimonial__item">
          <p>
            “Nam hendrerit quam eu neque egestas, nec lobortis enim rutrum. Quisque ligula tortor, mollis a efficitur
            vitae, imperdiet et mauris. Nam in orci quis risus dapibus mollis.“
          </p>
    ...
    <div class="about-services-shape">
      <img src="dist/images/shape/line02.png" alt="shape" class="img-fluid img-shape-01" />
      <img src="dist/images/shape/dots/dots-img-13.png" alt="shape" class="img-fluid img-shape-02" />
      <img src="dist/images/shape/l02.png" alt="shape" class="img-fluid img-shape-03" />
    </div>
  ...
  <section class="section main-become-instructor">
      ...
      <div class="row">
        <div class="col-lg-6">
          <div class="main-become-instructor-item me-12">
            <div class="main-image">
              <img src="dist/images/event/image01.png" alt="image" class="img-fluid" />
            </div>
            <div class="main-text">
              <h6 class="font-title--sm">Become an Instructor</h6>
              <p>
                Praesent ultricies nulla ac congue bibendum. Aliquam tempor euismod purus posuere gravida. Praesent augue
                sapien, vulputate eu imperdiet eget, tempor at enim.
              </p>
        ...
        <div class="col-lg-6">
          <div class="main-become-instructor-item ms-12 mb-0">
            <div class="main-image">
              <img src="dist/images/event/image02.png" alt="image" class="img-fluid" />
            </div>
            <div class="main-text">
    ...
    <div class="main-become-instructor-shape">
      <img src="dist/images/shape/line03.png" alt="shape" class="img-fluid" />
    </div>
  </section>
        ...
        <div class="col-lg-8 mx-auto">
          <div class="newsletter-area">
            ...
            <p class="mt-2 mb-lg-4 mb-3">
              ...
              et faucibus magna eros quis arcu.
            </p>
            <form>
    ...
    Allblog() {
      DataService.home()
        .then(response => {
          ...
          if (response.data)
            this.course_categories = response.data;
          else
